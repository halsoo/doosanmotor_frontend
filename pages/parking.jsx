...
function Parking(props) {
    return (
        <div className="w-full h-screen sm:px-xl lg:desktop-padding">
            ...
            <p className="p2centerop60 mt-lg">더 편리한 이용을 위해 카카오 채널을 추가해주세요!</p>

            <Buttons 
                className="sm:w-parking-button lg:w-parking-button-desktop mx-auto absolute bottom-4xl inset-x-0"
                name="kakaoChannel" 
            />
        </div>
    )
